...
\begin{itemize}
	\item To design the system architecture for the power source that integrates photovoltaic panels, energy storage, and a power inverter, ensuring sufficient capacity for powering small-to-medium scale appliances.
