...
\begin{enumerate}[label=\alph*.]
	...
	\begin{itemize}
		...
		\item \textit{Location} – The real-time position of the rented portable power source as monitored by the GPS module. It indicates where the unit is located during operation.
