...
\begin{enumerate}[label=\alph*.]
	...
	\begin{itemize}
		...
		\item \textit{Notification} –  Refers to the alerts sent to the user via the GSM module. It informs the user to return the item within 12 hours. Notifications are sent at 10-minute intervals until the item is returned.
