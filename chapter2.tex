...
\begin{enumerate}[label=\alph*.]
	...
	\begin{itemize}
		...
		Coin, Application, GPS Module, GSM Module, Power (Detachable), Stored Credit (Application)
		
		\item \textbf{Dependent Variables (DV)}\\
		Power (Detachable), User Information, User Verification, Location, Notification, Stored Credit (Application)
	\end{itemize}
	...
	\begin{itemize}
		\item \textbf{Coin} – Serves as the physical input medium that activates the system’s rental process through coin insertion, enabling users to access the detachable power source.
		
		\item \textbf{Application} – The mobile interface that allows users to create accounts, manage stored credits, and process payments through app-based transactions.
		
		\item \textbf{GPS Module} – A component responsible for gathering the real-time location of the detachable power source.
		
		\item \textbf{GSM Module} – Facilitates wireless communication between the portable power station, the administrator and user by transmitting system data such as location, status updates, and notifications.
		
		\item \textbf{Power (Detachable)} – Refers to the removable power supply module that delivers electrical energy. It enables portable and flexible energy management, allowing the system to monitor power consumption during rental operations. Any remaining or unused power from the detachable unit is recorded by the system and converted into stored credit within the application, promoting efficient utilization of energy resources.
		
		\item \textbf{Stored Credit (Application)} – The virtual balance maintained within the mobile application, representing prepaid user credits used to initiate or extend power rentals.
	\end{itemize}
	
		\textbf{Dependent Variables}
	\begin{itemize}
		\item \textbf{Power (Detachable)} – The energy made available after the insertion of a coin or use of stored credits.
		
		\item \textbf{User Information} – Data collected from the application used to identify and manage user accounts.
		
		\item \textbf{User Verification} – The process of authenticating users before allowing access to the system.
		
		\item \textbf{Location} –The real-time position of the detachable power source, determined by the GPS and GSM modules.
		
		\item \textbf{Notification} – System-generated alerts sent via GSM to inform users or administrators of system activities.
		
		\item \textbf{Stored Credit (Application)} – The system’s record of remaining power or credit balance available for rental use.
	\end{itemize}
	...
	The independent variables directly influence the dependent variables.
		...
		\begin{itemize}
		 \item \textbf{Coin} $\rightarrow$ \textbf{Power (Detachable)}\\
		  The insertion of a coin activates the rental mechanism, enabling the user to access and utilize the detachable power source.
		
		\item \textbf{Application} $\rightarrow$ \textbf{User Information / User Verification}\\ 
		The application serves as the primary medium for collecting user data and verifying credentials to ensure legitimate access and secure transactions.
		
		 \item \textbf{GPS Module} $\rightarrow$ \textbf{Location}\\ 
		 The GPS module provides continuous monitoring of the detachable power unit’s position, allowing administrators to track and ensure its proper use.
		 
		  \item \textbf{GSM Module} $\rightarrow$ \textbf{Notification / Location}\\
		  The GSM module transmits the collected location data and system alerts, ensuring reliable communication between the power station, the user, and the administrator.
		  
		   \item \textbf{Power (Detachable)} $\rightarrow$ \textbf{ Stored Credit (Application)}\\
		   The detachable power supply unit provides electrical energy during system operation. The system monitors power consumption throughout the rental period, and any remaining or unutilized power from the detachable source is automatically converted into stored credit within the application. This process ensures efficient power utilization while linking the physical energy supply to the user’s virtual credit balance.
		   
		    \item \textbf{Stored Credit (Application)} $\rightarrow$ \textbf{ Power (Detachable)}\\
		    The user’s available stored credit within the application determines eligibility for rental access, thereby authorizing or restricting power usage based on remaining balance.
